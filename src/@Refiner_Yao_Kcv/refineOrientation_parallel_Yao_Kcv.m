...
function obj = refineOrientation_parallel_Yao_Kcv(obj)
...
x_centers_parfor    = zeros(temp_k_size,num_calculations);
y_centers_parfor    = zeros(temp_k_size,num_calculations);
metrics_parfor      = zeros(temp_k_size,num_calculations);
phis_parfor         = zeros(temp_k_size,num_calculations);
thetas_parfor       = zeros(temp_k_size,num_calculations);
psis_parfor         = zeros(temp_k_size,num_calculations);
bayes_probs_parfor  = zeros(temp_k_size,num_calculations);


parfor pj_ind = 1:size(target_proj_num,2)
    pj_num = target_proj_num(pj_ind);
