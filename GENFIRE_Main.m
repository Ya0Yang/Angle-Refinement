...
GENFIRE.filename_Projections = './data/pj.mat';
GENFIRE.filename_Angles = './data/angles.mat';
GENFIRE.filename_Support = './data/Emptysupport.mat'; 
% filename_InitialModel = '';
GENFIRE.filename_Results = './results/GENFIRE_rec.mat';

GENFIRE.numIterations = 50; 
GENFIRE.pixelSize = .5; 
GENFIRE.oversamplingRatio =2;
