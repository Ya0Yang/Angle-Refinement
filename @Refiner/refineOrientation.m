...
evaluateOrientation_func = @EVALUATOR.evaluateOrientation;
    ...
    for cur_phi = (phi+phi_search_range)
            for cur_theta = (theta+theta_search_range)
                    for cur_psi = (psi+psi_search_range)
                        ...
                        [metric, suggested_center_x, suggested_center_y] = evaluateOrientation_func(pj_num,cur_phi,cur_theta,cur_psi);
