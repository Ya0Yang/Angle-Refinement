function calc_pj = calculate3Dprojection_interp_wrapperZYX(obj,phi,theta,psi)
...
[calc_pj, ~] = calculate3Dprojection_interp_xyz(obj.modelK,phi,theta,psi); % get projection
