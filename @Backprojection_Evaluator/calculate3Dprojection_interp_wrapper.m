function calc_pj = calculate3Dprojection_interp_wrapper(obj,phi,theta,psi)
...
nc_padded2    = round((size(obj.modelK,2)+1)/2);
cropInd1      = (1:dim1)-ncx + nc_padded1;
cropInd2      = (1:dim2)-ncy + nc_padded2;

[calc_pj, ~] = calculate3Dprojection_interp(obj.modelK,phi,theta,psi); % get projection
